package org.hgarcia.springcloud.msvc.usuarios.controllers;

import org.hgarcia.springcloud.msvc.usuarios.models.entity.Usuario;
import org.hgarcia.springcloud.msvc.usuarios.services.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<?>  crear(@Valid @RequestBody Usuario usuario, BindingResult result){
        if(!usuario.getEmail().isBlank() && service.porEmail(usuario.getEmail()).isPresent()){
